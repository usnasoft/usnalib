...
public class ViewsTabBar extends JToolBar {
	...
	protected final Map<View, JButton> viewsList = new HashMap<View, JButton>();
	...
	protected ImageIcon getCloseIcon() {
		if(closeIcon == null) {
			closeIcon = new ImageIcon(ViewsTabBar.class.getResource("/usna/img/close.gif"));
		}
		return closeIcon;
	}
	...
	protected ImageIcon getCloseOverIcon() {
		if(closeOverIcon == null) {
			closeOverIcon = new ImageIcon(ViewsTabBar.class.getResource("/usna/img/close_ov.gif"));
		}
