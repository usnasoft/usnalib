...
public class CalculatorPanel extends JPanel {
	...
	private JButton getBMemStore() {
		if (bMemStore == null) {
			...
			bMemStore.addActionListener(new java.awt.event.ActionListener() {
	...
	private JButton getBMemRecall() {
		if (bMemRecall == null) {
			...
			bMemRecall.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					displayPut(mem);
					opExecuted = false;
				}
	...
	private JButton getBMemAdd() {
		if (bMemAdd == null) {
			...
			bMemAdd.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
	...
	private JButton getBMemSubtract() {
		if (bMemSubtract == null) {
			...
			bMemSubtract.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
