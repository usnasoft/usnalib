package usna.examples.mvcfreeeditor;
...
import usna.mvc.extra.LookAndFeelMenu;
import usna.mvc.extra.WindowsMenu;
import usna.mvc.view.FreeView;
import usna.swing.SimpleFileFilter;
import usna.swing.dialog.FindReplaceDialog;
		...
		if (jMenuItemOpen == null) {
			...
			jMenuItemOpen.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
				    ...
				    chooser.addChoosableFileFilter(new SimpleFileFilter("SQL script file (*.sql)", ".sql"));
				    chooser.addChoosableFileFilter(new SimpleFileFilter("Text file (*.txt)", ".txt"));
	...
	private JMenuItem getJMenuItemSave() {
		if (jMenuItemSave == null) {
			...
			jMenuItemSave.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					((EdController)controller).saveCurrentModel();
				}
			});
		}
	...
	private JMenuItem getJMenuItemSaveAs() {
		if (jMenuItemSaveAs == null) {
			...
			jMenuItemSaveAs.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					((EdController)controller).saveAsCurrentModel();
				}
			});
		}
	...
	private JMenuItem getJMenuItemFind() {
		if (jMenuItemFind == null) {
			...
			jMenuItemFind.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					final FindReplaceDialog df = new FindReplaceDialog(getDialogParent(), jTextArea);
