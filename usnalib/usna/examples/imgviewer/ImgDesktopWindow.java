...
import usna.mvc.extra.ViewsTabBar;
		...
		if (jMenuItemOpen == null) {
			...
			jMenuItemOpen.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
				    ...
				    chooser.addChoosableFileFilter(new SimpleFileFilter("gif Image (*.gif)", ".gif"));
				    chooser.addChoosableFileFilter(new SimpleFileFilter("jpeg image (*.jpg, *.jpeg)", ".jpg", ".jpeg"));
