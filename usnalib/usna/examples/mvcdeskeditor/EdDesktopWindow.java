package usna.examples.mvcdeskeditor;
	...
	private JMenuItem getJMenuFind() {
		if (jMenuFind == null) {
			...
			jMenuFind.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					controller.signalTopmostView(EdController.CtrlMsg.FIND);
				}
			});
		}
		return jMenuFind;
